                    ...
                    {productCards.map((card, index) => (
                        <section className="w-full md:w-1/3 text-center mb-16 md:mb-0" key={index}>
                            <div  className="flex flex-row space-x-7 items-center">
                                <div  aria-labelby={'image-one-' + index} className="w-1/2 rounded-4xl overflow-hidden green-shadow">
                                    <img src={card.imageOne} aria-labelby={'image-one-' + index} alt={'image-one-' + index} />
                                </div>
                                <div  aria-labelby={'image-two-' + index} className="w-1/2 rounded-4xl overflow-hidden green-shadow">
                                    <img src={card.imageTwo} aria-labelby={'image-one-' + index} alt={'image-two-' + index} />
                                </div>
                            </div>
