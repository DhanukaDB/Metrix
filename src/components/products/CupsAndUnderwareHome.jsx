                     ...
                     <section aria-labelledby={formatTitles(product.title) + '-section'} className="mt-10 mb-32 md:mb-0" key={index}>
                        ...
                        <div className="text-center my-14">
                           <span className="text-center">
                              <Link to={product.path} role="link" aria-labelledby={formatTitles(product.title) + '-see-all-products-' + index} title={'Link to view product.title all products ' + index}
