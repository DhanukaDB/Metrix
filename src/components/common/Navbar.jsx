...
const Navbar = () => {
  ...
  return (
    <nav  className="w-full flex py-8 md:py-14 justify-between items-center navbar px-7 md:px-20" aria-labelby="app-menu">
                ...
                <ul   className="products-menu absolute shadow-xl bg-white rounded-xl p-4 mt-2 z-50">
                  {
                    nav.subMenu.map((menu, menuIndex) => (
                      <li    className="mb-3 last:mb-0 hover:text-primaryGreen w-full hover:cursor-pointer" key={menuIndex}>
                        <NavLink   to={menu.path} end={nav.path !== 'products' ? true : false} aria-labelby={'sub-nav-item-' + menuIndex} className="font-poppins w-full"
