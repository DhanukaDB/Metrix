  ...
  return (
    <nav role="menu" className="w-full flex py-8 md:py-14 justify-between items-center navbar px-7 md:px-20" aria-label="app-menu">
      ...
      <div className="sm:hidden flex flex-1 justify-end items-center">
        ...
        <div role="menu" className={`${!toggle ? "hidden" : "flex"} px-3 py-6 bg-white/80 shadow-lg absolute top-20 right-0 my-5 w-foll h-[89%] min-w-[140px] rounded-xl z-40 sidebar`}>
          <ol role="group" className="list-none flex justify-center items-center flex-1 flex-col">
            {navLinks.map((nav, index) => (
